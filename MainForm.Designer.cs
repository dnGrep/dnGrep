namespace nGREP
{
	partial class MainForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.btnSearch.Location = new System.Drawing.Point(404, 300);
			...
			this.gbFilter.Controls.Add(this.radioButton1);
			this.gbFilter.Controls.Add(this.radioButton2);
			...
			this.radioButton1.Text = "Size is";
			...
			this.radioButton2.Text = "All sizes";
			...
			this.tbFileSizeFrom.TabIndex = 6;
			// 
			// tbFileSizeTo
			// 
			...
			this.btnReplace.Location = new System.Drawing.Point(323, 300);
