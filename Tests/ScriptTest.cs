...
namespace Tests
{
    public class ScriptTest : TestBase
    {
        ...
        [InlineData("set filesizefilter yes")]
        [InlineData("set filesizefilter no")]
        [InlineData("set filesizefilter none")]
        ...
        [InlineData("showfileoptions true")]
        [InlineData("showfileoptions false")]
        ...
        [InlineData("set filesizefilter true", ScriptValidationError.ConvertValueFromStringFailed)]
        [InlineData("set includehidden 1", ScriptValidationError.ConvertValueFromStringFailed)]
        [InlineData("reset all", ScriptValidationError.UnneededValueFound)]
