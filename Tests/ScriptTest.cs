...
namespace Tests
{
    public class ScriptTest : TestBase
    {
        ...
        [InlineData("set filetimerange minutes")]
        [InlineData("set filetimerange hours")]
        [InlineData("set filetimerange days")]
        [InlineData("set filetimerange weeks")]
        [InlineData("set filetimerange months")]
        [InlineData("set filetimerange years")]
        ...
        [InlineData("set timerangefrom -12")]
        [InlineData("set timerangeto 0")]
