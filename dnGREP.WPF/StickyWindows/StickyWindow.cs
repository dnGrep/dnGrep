...
namespace Blue.Windows
{
    ...
    public class StickyWindow : System.Windows.Forms.NativeWindow
    {
        ...
        /// </summary>
        private static List<IFormAdapter> GlobalStickyWindows = new List<IFormAdapter>();
        private Dictionary<IFormAdapter, StuckWindow> stuckWindows = new Dictionary<IFormAdapter, StuckWindow>();
        ...
        /// <summary>
        /// Allows stuck windows to be dragged together
        /// Default value = true
        /// </summary>
        public bool MoveStuckTogether
        {
            get { return moveStuck; }
            set { moveStuck = value; }
        }
        /// <summary>
        /// Sets in
        ...
        /// </summary>
        /// <param name="bInsideStick">Allow snapping on the inside (eg: window to screen)</param>
        public List<IFormAdapter> GetStuckWindows(bool bInsideStick)
        {
